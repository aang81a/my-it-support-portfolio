...
| [Network Troubleshooting Cases](./PROJECTS/06-network-troubleshooting-cases/README-case-04.md) | IPv4 misconfiguration, DHCP restore, `ipconfig`, `ping`, Ethernet vs Wi-Fi vs mobile hotspot comparison |
