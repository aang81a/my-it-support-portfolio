...
|---|---|
| [01 Home Lab Environment](./PROJECTS/01-home-lab-environment/lab-environment-overview.md) | Lab inventory, hardware documentation, storage devices, backup systems, practical IT support environment |
