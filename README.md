...
- [Remote Support Tools Workflow](./PROJECTS/09-remote-support-simulation/)
...
|---|---|
| [Network Troubleshooting Cases](./PROJECTS/04-network-troubleshooting-cases/) | IPv4 misconfiguration, DHCP restore, `ipconfig`, `ping`, Ethernet vs Wi-Fi vs mobile hotspot comparison |
