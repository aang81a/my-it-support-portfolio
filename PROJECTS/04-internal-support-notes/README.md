...
![Type](https://img.shields.io/badge/Type-Documentation%20Index-purple)
...
This folder contains internal support notes, SOPs, runbooks, checklists, cheat sheets, and incident mini-reports for common first-level IT support tasks.

The documents are written for IT support technicians and focus on repeatable troubleshooting, administration, security awareness, and professional ticket documentation.

---

## Purpose

The purpose of this section is to demonstrate concise technical documentation for internal IT support use.

Each document shows how a common support task, incident, or technical concept can be documented in a simple, structured, and consistent format.

---

## Topics Covered

- Active Directory user and account support
- Domain join and password reset procedures
- Network access and shared drive troubleshooting
- Microsoft 365 and OneDrive support
- Windows 11 patching, performance, and hardening
- Backup and restore verification
- Basic vulnerability management awareness
...
| [How to Create a User in Active Directory](./04-internal-support-notes/active-directory/how-to-create-a-user-in-active-directory.md) | Active Directory | SOP | Internal procedure for creating a new domain user account |
...
- Technical writing for internal IT support documentation
- SOP, runbook, checklist, cheat sheet, and incident-report writing
- First-level troubleshooting documentation
- Active Directory support awareness
- Windows 11 support awareness
- Microsoft 365 and OneDrive support awareness
- Network troubleshooting documentation
- Backup and restore verification awareness
- Security and access-control awareness
- Ticket documentation and escalation logic

---

## Notes

These documents are written as portfolio examples for internal IT support documentation.

They demonstrate structured thinking, safe first-level support boundaries, evidence collection, escalation awareness, and clear communication for support teams.
