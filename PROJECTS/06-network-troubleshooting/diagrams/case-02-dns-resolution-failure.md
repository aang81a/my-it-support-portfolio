...
The DNS-specific logic: IP connectivity works, name resolution fails, DNS settings are checked or corrected, the DNS cache is flushed, and access is verified.
