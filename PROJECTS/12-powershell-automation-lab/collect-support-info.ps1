# ==========================================================
# Script: collect-support-info.ps1
# Version: 1.1.0 (2026-05-11)
# Purpose: Collect support-relevant system metadata for 1st Level Support
# ==========================================================

Write-Host "Gathering System Information... Please wait." -ForegroundColor Cyan

# --- STEP 1: GATHER ANTIVIRUS DATA ---
