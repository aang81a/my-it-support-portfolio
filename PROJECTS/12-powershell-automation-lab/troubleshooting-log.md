...
| 22 | [`ts-22-output-no-mcafee-shortcut.png`](screenshots/ts-22-output-no-mcafee-shortcut.png)<br><img src="screenshots/ts-22-output-no-mcafee-shortcut.png" alt="Final report without stale McAfee entry" width="350"> | The final generated report no longer showed the stale McAfee entry. |
