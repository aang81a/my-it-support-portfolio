...
| Computer 4 – Legacy WD SATA HDD source (2006) | Legacy storage source for backup / additional hardware test system | Used as the source device for checking old files and preparing backup through Computer 2 |
