...
|---|---|---|
| Computer 1 – Legacy ASUS desktop | Legacy storage and BIOS troubleshooting system | ASUS-branded desktop with Intel Pentium D CPU, ASUS DVD/CD writer, LG DVD/CD writer, and VIPower/SuperRack drive bay; used for Samsung SP1203N IDE/PATA HDD testing, DVD/CD drive testing, and BIOS boot order checks |
